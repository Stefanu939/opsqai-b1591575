...
const LEGACY_ALLOWED = new Set([
  ...
  "src/lib/avatar.ts",
  "src/lib/first-run.server.ts",
  "src/lib/email/logs.functions.ts",
  "src/routes/auth.tsx",
  ...
  "src/routes/api/public/v1/-_auth.ts",
  "src/routes/api/public/v1/license/releases.ts",
  "src/routes/api/public/v1/license/heartbeat.ts",
