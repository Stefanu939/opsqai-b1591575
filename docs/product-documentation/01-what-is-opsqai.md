...
- A **modular product**: one mandatory *Installation License* + optional per-module licenses (Knowledge Base, Academy, Chat, FAQ, SOPs, Brand, Internal Requests, Workspace).
