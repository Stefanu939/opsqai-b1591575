  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div>
          <p className="mc-eyebrow text-[var(--mc-fg-dim)]">Billing</p>
          <h2 className="mc-heading text-xl font-semibold tracking-tight flex items-center gap-2 text-[var(--mc-fg)]">
            <ShieldCheck className="h-5 w-5 text-[var(--mc-gold)]" /> Subscription Lifecycle
          </h2>
          <p className="text-sm text-[var(--mc-fg-muted)] mt-1">
            Trial, grace period, suspendare și reactivare automată — cu overrides manuale.
          </p>
        </div>
        ...
        {company && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="pt-2">
                    ...
                    <Textarea value={reason} onChange={(e) => setReason(e.target.value)} rows={2} placeholder="e.g. Retention hold" />
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm flex items-center gap-2"><Clock className="h-4 w-4" /> Grace period</CardTitle>
                </CardHeader>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm flex items-center gap-2"><CalendarClock className="h-4 w-4" /> Renewal &amp; billing</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="text-xs text-muted-foreground">
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm flex items-center gap-2"><FileText className="h-4 w-4" /> Override &amp; notes</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  ...
                  <div>
                    ...
                    <Textarea rows={3} value={notes} onChange={(e) => setNotesState(e.target.value)} placeholder={company.internal_notes ?? "Add internal context"} />
                    ...
                    <tbody>
                      {(events.data?.events ?? []).map((e: any) => (
                        <tr key={e.id} className="border-t">
                          ...
                          <td className="px-3 py-2"><Badge variant="secondary" className="text-[10px]">{e.actor_kind}</Badge></td>
                          <td className="px-3 py-2 text-muted-foreground">{e.reason ?? "—"}</td>
                        </tr>
                      ))}
                      {!events.data?.events?.length && (
                        <tr>
                          <td colSpan={5} className="px-3 py-4 text-center text-muted-foreground">No events yet.</td>
                        </tr>
                      )}
                    </tbody>
                  </table>
