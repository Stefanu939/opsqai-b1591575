      ...
      <DialogContent className="max-w-md" onEscapeKeyDown={(e) => e.preventDefault()} onPointerDownOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          ...
          <DialogDescription className="pt-1 leading-relaxed">
            You've experienced how OPSQAI centralizes operational knowledge, AI assistance, onboarding and compliance in one governed platform.
            <br /><br />
            Ready to use it with your own company?
          </DialogDescription>
        </DialogHeader>
        <DialogFooter className="gap-2 sm:gap-2">
          <Button variant="outline" onClick={() => { end(); navigate({ to: "/demo" }); }}>Restart demo</Button>
