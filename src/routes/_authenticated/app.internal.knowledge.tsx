...
function SystemKnowledge() {
  ...
  const filtered = docs.filter((d) => {
    ...
    return (
      ...
      d.system_slug.toLowerCase().includes(needle)
    );
  });
    ...
    <div className="max-w-5xl mx-auto w-full p-6 space-y-6">
      ...
      {loading ? (
        ...
        <Card className="p-8 text-center text-sm text-muted-foreground">
          No system documents yet. Go to{" "}
          <Link to="/app/internal" className="text-primary underline">
            Overview
          </Link>{" "}
          and click <strong>Regenerate</strong>.
        </Card>
      ) : (
