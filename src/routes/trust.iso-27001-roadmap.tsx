  ...
  component: () => (
    ...
    >
      ...
      <ul>
        ...
        <li>Subprocessor inventory and draft DPA — see <a href="/trust">Trust Center</a>.</li>
      </ul>
      <h2>Not yet started</h2>
      <p>
        The following ISO/IEC 27001 alignment items are <strong>not yet started</strong>. We list them as
        gaps rather than "in progress" because no named owner or milestone date is attached to them yet:
      </p>
      <ul>
      ...
      <p>
        No time-bound certification milestone has been fixed yet. We will only publish target dates once
        an accredited auditor is engaged and a Stage 1 review is scheduled. Until then, please treat any
        third-party summary describing OPSQAI as "SOC 2 ready" or "audit-ready" as inaccurate.
      </p>
