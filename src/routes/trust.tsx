  ...
  head: () => ({
    meta: [
      { title: "Trust Center — OPSQAI" },
      {
        name: "description",
        content:
          "How OPSQAI protects customer data: multi-tenant isolation, encryption, audit logs, GDPR, responsible AI and incident response.",
      },
      { property: "og:title", content: "Trust Center — OPSQAI" },
      {
        property: "og:description",
        content: "Security, privacy and compliance posture for OPSQAI.",
      },
...
const SUBPROCESSORS: {
  ...
  role: string;
  region: string;
  certainty: "direct-audited" | "direct-pending" | "indirect";
}[] = [
  {
    name: "Cloudflare, Inc. (USA)",
    role: "Edge runtime, DNS, DDoS protection",
    region:
      "Headquartered in the USA (San Francisco). ISO/IEC 27001, ISO/IEC 27701, SOC 2 Type II and PCI DSS Level 1 certified. International transfers safeguarded by Standard Contractual Clauses (Art. 46 GDPR) or the EU-U.S. Data Privacy Framework, per Cloudflare's Data Processing Addendum, accepted by OPSQAI.",
  ...
  },
  {
    ...
    region:
      "Application database in AWS eu-west-1 (Dublin, Ireland). Lovable holds SOC 2 Type II and ISO 27001:2022 certifications at the company level. Our current subscription is Lovable's Pro tier; Business-tier contractual DPA coverage is being confirmed and documentation will be provided upon request. This does not imply OPSQAI itself is certified.",
  ...
  },
  {
    ...
    region:
      "OPSQAI does not contract directly with OpenAI; access is via the Lovable AI Gateway under Lovable's own agreement with OpenAI. Customer content is not used to train foundation models, per Lovable's Gateway terms. International transfers safeguarded by Standard Contractual Clauses (Art. 46 GDPR) or an equivalent adequacy mechanism.",
    certainty: "indirect",
  },
];
    ...
    <MarketingLayout>
      <section className="mx-auto max-w-4xl px-4 py-16 md:py-24">
        ...
        <p className="mt-5 text-lg text-muted-foreground">
          This page is maintained by OPSQAI to summarize how we protect customer data, isolate
          tenants and operate the platform responsibly. It is informational and is not a substitute
        ...
        <div className="mt-8 rounded-lg border border-border/60 bg-muted/30 p-5 text-sm leading-relaxed">
          ...
          <p className="mt-2 text-muted-foreground">
            OPSQAI (the product and company) is{" "}
            <strong className="text-foreground">
              not currently SOC 2 or ISO/IEC 27001 certified
            </strong>
            . Our infrastructure subprocessor's platform (
            <strong className="text-foreground">Lovable</strong>) holds
            <strong className="text-foreground"> SOC 2 Type II</strong> and
            <strong className="text-foreground"> ISO 27001:2022</strong> certifications at the
            company level. Our current subscription is{" "}
            <strong className="text-foreground">Lovable's Pro tier</strong>;
            <strong className="text-foreground">
              {" "}
              Business-tier contractual coverage is being confirmed
            </strong>{" "}
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          OPSQAI engages the following subprocessors to operate the service. Customers are notified
          of material changes.
        </p>
        <div className="mt-5 overflow-hidden rounded-lg border border-border/60">
          <table className="w-full text-sm">
            <thead className="bg-muted/40 text-xs uppercase tracking-wider text-muted-foreground">
              <tr>
                <th className="text-left p-3">Subprocessor</th>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Detailed write-ups on the controls behind OPSQAI.
        </p>
        <div className="mt-5 grid gap-2 md:grid-cols-2 lg:grid-cols-3 text-sm">
          {[
            ...
            <Link
              key={t.to}
              to={t.to}
              className="rounded-md border border-border/60 px-4 py-3 hover:bg-muted/40"
            >
              {t.label} →
            </Link>
          ))}
      ...
      <section className="mx-auto max-w-4xl px-4 pb-20">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          ...
          with a description, reproduction steps and your contact details. We will acknowledge
