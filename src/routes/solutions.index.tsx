...
export const Route = createFileRoute("/solutions/")({
  head: () =>
    pageHead({
      ...
      path: "/solutions",
      keywords:
        "warehouse AI, SOP assistant, onboarding, compliance, shift handover, audit readiness",
      breadcrumbs: [
        { name: "Home", path: "/" },
...
const SOLUTIONS = [
  ...
  },
  {
    ...
    bullets: [
      "Refusal instead of guesses",
      "One-click promotion to FAQ / SOP",
      "Closes the loop on missing knowledge",
    ],
  },
  {
    icon: Wrench,
    ...
    <MarketingLayout>
      <section className="mx-auto max-w-4xl px-4 py-16 md:py-24">
        ...
        <h1 className="mt-2 text-4xl md:text-5xl font-semibold tracking-tight">
          Built for how warehouse teams actually work.
        </h1>
        <p className="mt-5 text-lg text-muted-foreground">
          OPSQAI is not a generic chatbot. Each solution below is grounded in real operations on the
          floor — fast answers, cited sources, and a clear path to fill the gaps.
        </p>
      </section>
        ...
        <div className="grid gap-3 md:grid-cols-2">
          {SOLUTION_PAGES.map((s) => (
            <Link
              ...
              to="/solutions/$slug"
              params={{ slug: s.slug }}
              className="group rounded-xl border border-border/60 bg-card/40 p-5 transition hover:border-primary/50 hover:bg-card"
            >
      ...
      <section className="mx-auto max-w-4xl px-4 pb-20 text-center">
        ...
        <p className="mt-2 text-muted-foreground">
          A 20-minute working session with your real documents.
        </p>
