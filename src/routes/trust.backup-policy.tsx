  ...
  component: () => (
    ...
    >
      ...
      <ul>
        ...
        <li><strong>Point-in-time recovery (PITR):</strong> supported within the retention window at second-level granularity.</li>
        <li><strong>Object storage (knowledge-base files):</strong> redundant storage in the EU region; versioning is enabled on the bucket so accidental overwrites can be rolled back.</li>
      </ul>
      <h2>Recovery objectives</h2>
      <ul>
        <li><strong>RPO (Recovery Point Objective):</strong> ≤ 5 minutes for the application database.</li>
        <li><strong>RTO (Recovery Time Objective):</strong> ≤ 4 hours for a full database restore in the same region.</li>
      </ul>
      ...
      <p>Tenant admins can export their knowledge base and audit logs at any time via the admin area. We recommend customers keep an external copy of mission-critical SOPs.</p>
    </TrustTopic>
  ),
});
