...
export const Route = createFileRoute("/trust/gdpr")({
  head: () => ({
    meta: [
      { title: "GDPR — OPSQAI Trust Center" },
      {
        name: "description",
        content:
          "How OPSQAI complies with EU GDPR: lawful basis, data subject rights, EU hosting, DPA and subprocessors.",
      },
  ...
  component: () => (
    ...
    >
      ...
      <h2>Roles</h2>
      <p>
        Our customers are the <strong>data controllers</strong>. OPSQAI acts as a{" "}
        <strong>data processor</strong> for the SOPs, FAQs, questions and user accounts that
        customers store in their tenant.
      </p>
      <h2>Hosting region</h2>
      <p>
        The OPSQAI application database is hosted on managed Supabase infrastructure in
        <strong> AWS eu-west-1 (Dublin, Ireland)</strong>. Edge requests may terminate at the
        closest Cloudflare point of presence, but persistent tenant storage stays in the EU region
        above.
      </p>
      ...
      <p>
        ...
        and the relevant documentation will be provided upon request. Subprocessor certification
        reduces, but does not eliminate, OPSQAI's own responsibility as a data processor under Art.
        28 GDPR.
      </p>
      ...
      <ul>
        <li>
          ...
          closest Cloudflare point of presence.
        </li>
        <li>
          <strong>Lovable</strong> — application database, authentication, storage and AI gateway.
          SOC 2 Type II and ISO 27001:2022 certifications at the company level. Our current
          subscription is Lovable's Pro tier;{" "}
          <strong>Business-tier contractual DPA coverage is being confirmed</strong>
          and documentation will be provided upon request. This does not imply OPSQAI itself is
          certified.
        </li>
        <li>
          ...
          International transfers safeguarded by Standard Contractual Clauses (Art. 46 GDPR) or an
          equivalent adequacy mechanism, applied independently to Google and to OpenAI.
        </li>
      </ul>
      ...
      <p>
        ...
        <strong> Google</strong> (Gemini models for chat / retrieval responses) and{" "}
        <strong>OpenAI</strong>
        (models for embeddings, text-to-speech and selected generation tasks), both routed through
        the Lovable AI Gateway — such transfers are safeguarded by the European Commission's
        <strong> Standard Contractual Clauses (SCCs) under Article 46 GDPR</strong>, or an
        equivalent adequacy mechanism where one applies. Whether customer content may be used to
        train third-party foundation models is a separate legal question, addressed independently on
        our <a href="/legal/responsible-ai">Responsible AI</a> page and in our DPA.
      </p>
      <h2>Data subject rights</h2>
      <ul>
        <li>
          <strong>Access &amp; portability:</strong> Admins can export their tenant's data on
          request.
        </li>
        <li>
          <strong>Erasure:</strong> Tenant deletion removes the company record and cascading rows.
        </li>
        <li>
          <strong>Rectification:</strong> Users update their own profile; admins manage roles within
          the tenant.
        </li>
        <li>
          <strong>Objection / restriction:</strong> Handled per the DPA, routed via the controller.
        </li>
      </ul>
      <h2>Legal documents</h2>
      <ul>
        <li>
          Data Processing Agreement (DPA) — available on request and as a public draft at{" "}
          <code>/legal/dpa</code>. Currently pending final legal review.
        </li>
        <li>
          Privacy Policy — <code>/legal/privacy</code>.
        </li>
        <li>Subprocessor list — see the main Trust Center page.</li>
      </ul>
      <h2>Contact</h2>
      <p>
        Privacy questions: <a href="mailto:notify@opsqai.de">notify@opsqai.de</a>.
      </p>
    </TrustTopic>
  ),
});
