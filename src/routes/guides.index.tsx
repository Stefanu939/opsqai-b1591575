    ...
    <main className="mx-auto max-w-6xl px-6 py-20">
      ...
      <header className="mb-14 max-w-3xl">
        ...
        <h1 className="text-4xl font-semibold tracking-tight text-foreground md:text-5xl">
          Step-by-step playbooks for operational leaders.
        </h1>
        <p className="mt-5 text-lg text-muted-foreground">
          Practical, opinionated guides written for teams rolling out enterprise AI across
          warehouses, distribution centers and 3PL operations.
        </p>
      </header>
      ...
      {GUIDES.length === 0 ? (
        <section className="rounded-2xl border border-dashed border-border/60 bg-card/30 p-10">
          ...
          >
            Ask us for an early copy <ArrowRight className="h-4 w-4" />
          </Link>
        </section>
      ) : (
