    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/discovery", changefreq: "monthly", priority: "1.0" },
          ...
          { path: "/solutions/logistics", changefreq: "monthly", priority: "0.8" },
          { path: "/solutions/hr", changefreq: "monthly", priority: "0.8" },
          { path: "/solutions/finance", changefreq: "monthly", priority: "0.8" },
          { path: "/solutions/transport", changefreq: "monthly", priority: "0.8" },
          ...
          { path: "/invest", changefreq: "monthly", priority: "0.7" },
          { path: "/blog", changefreq: "weekly", priority: "0.7" },
          { path: "/windows-only", changefreq: "monthly", priority: "0.6" },
