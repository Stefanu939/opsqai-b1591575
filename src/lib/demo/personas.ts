...
export const DEMO_PERSONAS: Record<string, DemoPersona> = {
  "00000000-0000-0000-0000-0000000da001": {
    ...
    name: "Anna Weber", initials: "AW", position: "Warehouse Manager",
    department: "Inbound Operations", role: "admin",
  },
  "00000000-0000-0000-0000-0000000da002": {
    id: "00000000-0000-0000-0000-0000000da002",
    name: "Marco Rossi", initials: "MR", position: "Team Leader — Inbound",
    department: "Inbound Operations", role: "team_leader",
  },
  "00000000-0000-0000-0000-0000000da003": {
    id: "00000000-0000-0000-0000-0000000da003",
    name: "Laura Nagy", initials: "LN", position: "Team Leader — Outbound",
    department: "Outbound Operations", role: "team_leader",
  },
  "00000000-0000-0000-0000-0000000da004": {
    id: "00000000-0000-0000-0000-0000000da004",
    name: "Jonas Fischer", initials: "JF", position: "Safety Officer",
    department: "Safety & Quality", role: "manager",
  },
  "00000000-0000-0000-0000-0000000da005": {
    id: "00000000-0000-0000-0000-0000000da005",
    name: "Sofia Ionescu", initials: "SI", position: "Forklift Operator",
    department: "Fleet & Yard", role: "employee",
  },
};
