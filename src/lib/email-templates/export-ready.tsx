...
const Email = (p: { fileName?: string; downloadUrl?: string; expiresAt?: string; format?: string }) => (
  <SimpleEmail
...
export const template = defineTemplate({
  ...
  component: Email,
  previewData: { fileName: "knowledge-export.zip", format: "ZIP", downloadUrl: APP_URL, expiresAt: "in 24 hours" },
});
