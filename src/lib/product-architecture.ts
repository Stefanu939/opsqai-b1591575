...
export const PRODUCT_WORKSPACES: readonly ProductWorkspace[] = [
  ...
  },
  {
    ...
    product: "opsqai_hr",
    label: "Employees",
    description: "Employee master data, lifecycle status and the full employee record.",
    icon: "Users",
    route: "/app/products/hr/employees",
    capabilities: ["hr_workspace"],
    coreCapabilities: ["audit_log", "enterprise_export"],
    status: "implemented",
  },
  {
    key: "hr_tasks",
    product: "opsqai_hr",
    label: "HR Tasks",
    description: "Onboarding, offboarding, expiries, approvals and reminders in one queue.",
    icon: "ListChecks",
    route: "/app/products/hr/tasks",
    capabilities: ["hr_workspace"],
    coreCapabilities: ["internal_requests", "audit_log"],
    status: "implemented",
  },
  {
    ...
    description: "Contract templates, generated documents, uploads, validity and approvals.",
    icon: "FileText",
    route: "/app/products/hr/documents",
    capabilities: ["hr_workspace"],
    coreCapabilities: ["audit_log", "enterprise_export"],
    status: "implemented",
  },
  {
    ...
    description: "Reusable checklists that expand into dated HR tasks per employee.",
    icon: "ListChecks",
    route: "/app/products/hr/lifecycle",
    capabilities: ["hr_workspace"],
    coreCapabilities: ["internal_requests", "audit_log"],
    status: "implemented",
  },
  {
    ...
    product: "opsqai_hr",
    label: "Equipment",
    description: "Company equipment, assignment to employees and return history.",
    icon: "Laptop",
    route: "/app/products/hr/equipment",
    capabilities: ["hr_workspace"],
    coreCapabilities: ["audit_log"],
    status: "implemented",
  },
  {
    key: "hr_incidents",
    ...
    description: "Documented incidents, warnings and the actions taken.",
    icon: "AlertTriangle",
    route: "/app/products/hr/incidents",
    capabilities: ["hr_workspace"],
    coreCapabilities: ["audit_log"],
    status: "implemented",
  },
  {
    ...
    description: "Job profiles, saved criteria, CV analysis with evidence, comparison and shortlist.",
    icon: "UserSearch",
    route: "/app/products/hr/screening",
    capabilities: ["hr_workspace"],
    coreCapabilities: ["audit_log"],
    status: "implemented",
  },
  {
    key: "hr_analytics",
    product: "opsqai_hr",
    label: "HR Analytics & Alerts",
    description: "Headcount, tenure, turnover, incidents and derived HR alerts.",
    icon: "BarChart3",
    route: "/app/products/hr/analytics",
    capabilities: ["hr_workspace"],
    coreCapabilities: ["reports", "enterprise_export"],
    status: "implemented",
  },
  {
    ...
    product: "opsqai_hr",
    label: "Settings",
    description: "Jurisdiction, employee numbering and HR reference data.",
    icon: "Settings",
    route: "/app/products/hr/settings",
    capabilities: ["hr_workspace"],
    coreCapabilities: ["audit_log"],
    status: "implemented",
  },
