...
export const FEATURE_CATALOG: FeatureDef[] = [
  ...
  { key: "ai_workspace_audit",  label: "AI Workspace Audit",   category: "AI", defaultState: "enabled" },
  { key: "ai_workspace",        label: "AI Workspace",         category: "AI", defaultState: "enabled" },

  // Knowledge
  { key: "knowledge_base",      label: "Knowledge Base",       category: "Knowledge", defaultState: "enabled" },
  { key: "faq",                 label: "FAQ",                  category: "Knowledge", defaultState: "enabled" },
  { key: "knowledge_gaps",      label: "Knowledge Gaps",       category: "Knowledge", defaultState: "enabled" },
  { key: "internal_requests",   label: "Internal Requests",    category: "Knowledge", defaultState: "enabled" },
  { key: "sop_versioning",      label: "SOP Versioning",       category: "Knowledge", defaultState: "enabled" },
  { key: "confidence_scoring",  label: "Confidence Scoring",   category: "Knowledge", defaultState: "enabled" },
  ...
  { key: "workspace_isolation", label: "Workspace Isolation",  category: "Governance", defaultState: "enabled" },
  { key: "compliance_center",   label: "Compliance Center",    category: "Governance", defaultState: "enterprise" },

  // Administration
  { key: "platform_admin",      label: "Platform Administration", category: "Administration", defaultState: "enabled" },
  { key: "executive_dashboard", label: "Executive Dashboard",  category: "Administration", defaultState: "enabled" },
  ...
  { key: "enterprise_export",   label: "Enterprise Export",    category: "Administration", defaultState: "enabled" },
  { key: "support_center",      label: "Support Center",       category: "Administration", defaultState: "enabled" },
  { key: "workspace_health",    label: "Workspace Health",     category: "Administration", defaultState: "enabled" },

  // Experience
  { key: "brand_center",        label: "Brand Center",         category: "Experience", defaultState: "enterprise" },
  { key: "academy",             label: "Academy",              category: "Experience", defaultState: "enabled" },
  { key: "multi_language",      label: "Multi-language",       category: "Experience", defaultState: "enabled" },
...
export const SECURITY_AREAS = [
  "Authentication", "Authorization", "Encryption", "Storage",
  "Infrastructure", "Backups", "Monitoring", "Incident Response",
  "Penetration Testing", "Vulnerability Management", "Logging",
