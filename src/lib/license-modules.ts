...
export const LICENSE_MODULE_CATALOG: LicenseModule[] = [
  ...
  },
  {
    ...
    defaultPriceCents: 0,
    inBasic: true,
    description: "Curated FAQ answers.",
  },
  {
    key: "notifications",
    label: "Notifications",
  ...
  {
    key: "bilingual_ui",
    label: "Bilingual UI (EN/DE)",
    category: "Basic",
    defaultPriceCents: 0,
    inBasic: true,
    description: "Built-in English + German UI.",
  },
  {
    key: "pwa",
  ...
  },
  {
    ...
    defaultPriceCents: 250000,
    inBasic: false,
    description: "GDPR, ISO 27001, DPA workflows.",
  },
  {
    key: "brand_center",
    label: "Brand Center",
    ...
    defaultPriceCents: 100000,
    inBasic: false,
    description: "White-label logos, colors, docs branding.",
  },
  {
  ...
  },
  {
    ...
    defaultPriceCents: 80000,
    inBasic: false,
    description: "Ask-a-manager ticketing flow.",
  },
  {
    key: "reports",
    label: "Reports",
    ...
    defaultPriceCents: 100000,
    inBasic: false,
    description: "Scheduled PDF/XLSX reports.",
  },
  {
  ...
  {
    key: "multi_language",
    label: "Multi-language Pack",
    category: "Experience",
    defaultPriceCents: 150000,
    inBasic: false,
    description: "Additional UI + content languages.",
  },
  {
    key: "support_center",
    ...
    defaultPriceCents: 80000,
    inBasic: false,
    description: "Built-in support ticketing.",
  },
];
