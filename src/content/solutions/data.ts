...
export const SOLUTION_PAGES: SolutionPage[] = [
  {
    ...
    capabilities: [
      { title: "Grounded chat", body: "Every response cites the SOP section that produced it." },
      {
        ...
        body: "Ingest PDFs, Word, Excel, Confluence exports; version and re-index automatically.",
      },
      {
        title: "Gap capture",
        body: "Refused answers convert into internal requests routed to knowledge owners.",
      },
      {
        title: "Audit & compliance",
        body: "Immutable log of prompts, retrieved sources, exports and admin actions.",
      },
    ],
    faq: [
      {
  ...
  },
  {
    ...
    lede: "OPSQAI's assistant is designed for shop-floor conditions: mobile-first, multilingual, tolerant of imperfect queries, and always cited to your own SOPs. Operators get answers in seconds; team leaders stop being pulled off the line to repeat the same procedure.",
    sections: [
      {
    ...
    capabilities: [
      {
        ...
        body: "Responsive chat, works offline for the last active thread.",
      },
      {
        title: "EN / DE / RO",
        body: "Operator asks in one language, source is in another — OPSQAI bridges both.",
      },
  ...
  },
  {
    ...
    lede: "Traditional knowledge bases die in wiki graveyards. OPSQAI is designed around retrieval — every document is chunked, embedded and version-tracked, and every query is answered from those chunks with an audit trail of what was used.",
    sections: [
      {
    ...
    capabilities: [
      {
        ...
        body: "Embedding-based retrieval, not brittle keyword matching.",
      },
      { title: "Version history", body: "Every ingested document keeps its version chain." },
      {
        title: "Owner routing",
        body: "Documents belong to a team; changes route to that owner for approval.",
      },
    ],
    relatedLandingPages: [
      { path: "/solutions/enterprise-knowledge-base", label: "Enterprise knowledge base" },
      {
        ...
        label: "Operational knowledge platform",
      },
    ],
  },
  {
    ...
    lede: "Operational knowledge is scattered — SharePoint folders, PDFs on shared drives, team-lead notebooks, group chats. OPSQAI collapses that surface into a single retrieval layer with strict tenant isolation and enterprise-grade governance (OPSQAI itself is not yet SOC 2 or ISO 27001 certified — see the Trust Center).",
    sections: [
      {
    ...
    capabilities: [
      {
        ...
        body: "Isolation enforced in PostgreSQL, not in application code.",
      },
  ...
  },
  {
    ...
    lede: "OPSQAI treats SOPs as living operational assets: draft, review, publish, acknowledge, version, retire — with a grounded AI assistant sitting on top so operators can query them in seconds.",
    sections: [
      {
    ...
    relatedLandingPages: [
      {
        ...
        label: "Warehouse documentation software",
      },
  ...
  },
  {
    ...
    keywords:
      "warehouse documentation software, distribution center documentation, operational documentation",
    eyebrow: "Warehouse documentation",
    lede: "Documentation only helps operations when it is findable at the moment of use. OPSQAI consolidates warehouse documentation into a single retrieval-grounded layer with mobile-first access and enterprise governance.",
    sections: [
      {
  ...
  },
  {
    ...
    lede: "OPSQAI is purpose-built for warehouse and distribution operations. Every capability — retrieval, refusal, multilingual output, gap capture, audit — is designed against real shop-floor constraints, not office productivity workflows.",
    sections: [
      {
    ...
    capabilities: [
      { title: "Refusal-first", body: "No answer without a citable source." },
      {
        ...
        body: "Clone a workspace, scope the knowledge base per site.",
      },
      {
        title: "Operations analytics",
        body: "See what operators are asking — and where SOPs are missing.",
      },
    ],
    relatedLandingPages: [
  ...
  },
  {
    ...
    keywords:
      "AI for distribution centers, 3PL AI, cross-site knowledge, multilingual warehouse AI",
    eyebrow: "AI for distribution centers",
    lede: "Distribution networks live and die by consistency. OPSQAI standardises operational answers across sites while preserving per-site sovereignty over knowledge, audit and access.",
    sections: [
      {
    ...
    capabilities: [
      {
        title: "Per-site scope",
        body: "Knowledge bases isolated per site with corporate overlays.",
      },
      { title: "Unified audit", body: "Cross-site queries and admin actions in one log." },
      {
        title: "Language bridging",
        body: "Corporate SOP in one language, operator asks in another.",
      },
    ],
    relatedLandingPages: [
      { path: "/solutions/ai-for-warehouse-operations", label: "AI for warehouse operations" },
  ...
  },
  {
    ...
    lede: "OPSQAI is the AI layer for teams whose day-to-day is defined by physical operations, safety rules and regulated procedures — warehousing, distribution, manufacturing support, field operations.",
    sections: [
      {
    ...
    capabilities: [
      {
        ...
        body: "Chat, SOP, Academy, Audit, Gaps — used together or independently.",
      },
      { title: "API-first", body: "Every module has an authenticated, RLS-enforced API surface." },
      {
        title: "Governance",
        body: "RBAC, audit, retention, export — the enterprise defaults, not add-ons.",
      },
    ],
    relatedLandingPages: [
  ...
  },
  {
    ...
    lede: "OPSQAI is designed for enterprises whose knowledge base has to hold up under an audit (OPSQAI itself is not yet SOC 2 or ISO 27001 certified — see the Trust Center): retrieval-grounded answers, immutable logs, versioned sources, and role-based access control from day one.",
    sections: [
      {
    ...
    capabilities: [
      {
        ...
        body: "Append-only log of prompts, sources, responses and admin actions.",
      },
      {
        title: "Versioned sources",
        body: "Answers reference a specific document version, retained indefinitely.",
      },
