  ...
  tiers: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Domain solutions on top of Core. OPSQAI Logistics is available today; OPSQAI Transport, HR, Finance and Inventory follow. A product is enabled for your company and delivered through your signed license — no reinstall.",
        bullets: [
  ...
  tiers: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Fachlösungen auf Basis von Core. OPSQAI Logistics ist heute verfügbar; OPSQAI Transport, HR, Finance und Inventory folgen. Ein Produkt wird für Ihr Unternehmen aktiviert und über Ihre signierte Lizenz ausgeliefert — ohne Neuinstallation.",
        bullets: [
  ...
  tiers: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Soluții de domeniu peste Core. OPSQAI Logistics este disponibil astăzi; OPSQAI Transport, HR, Finance și Inventory urmează. Un produs este activat pentru compania dumneavoastră și livrat prin licența semnată — fără reinstalare.",
        bullets: [
