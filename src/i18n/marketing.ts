...
const en = {
  nav: {
    ...
    security: "Security",
    pricing: "Pricing",
    compare: "OPSQAI vs. today",
    study: "Operations Study 2026",
    company: "Company",
...
const de: MarketingCopy = {
  nav: {
    ...
    security: "Sicherheit",
    pricing: "Preise",
    compare: "OPSQAI vs. heute",
    study: "Operations-Studie 2026",
    company: "Unternehmen",
...
const ro: MarketingCopy = {
  nav: {
    ...
    security: "Securitate",
    pricing: "Prețuri",
    compare: "OPSQAI vs. azi",
    study: "Studiu operațional 2026",
    company: "Companie",
