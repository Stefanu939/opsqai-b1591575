-- Country & compliance intelligence — org-level settings (Phase 3, Cloud).
-- Mirrors migrations/selfhost/0022_compliance_settings.sql. Advisory-only:
-- never asserts legal compliance, only records what the org opted into.
