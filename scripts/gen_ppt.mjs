...
// ---------- SLIDE 3: PROBLEM ----------
{
  ...
  subtitle(
    s,
    "Cunoașterea operațională este fragmentată în PDF-uri, chat-uri și oameni. Rezultatul: erori, întârzieri, onboarding lent.",
  );
...
// ---------- SLIDE 4: SOLUTION ----------
{
  ...
  subtitle(
    s,
    "OPSQAI transformă documentele, procedurile și expertiza internă într-un asistent AI de încredere — cu surse, audit și izolare totală per client.",
    1.7,
    true,
  );
  ...
  const pillars = [
    ...
    [
      "Multi-tenant SaaS",
      "Izolare completă la nivel de bază de date (RLS). Datele tale rămân ale tale.",
    ],
...
// ---------- SLIDE 5: PRODUCT MAP ----------
{
  ...
  const mods = [
    [
      "Assistant",
      "Chat AI cu surse",
      "Răspunsuri instant din KB-ul companiei, cu citări și confidence score.",
    ],
    [
      "Academy",
      "Onboarding & training",
      "Learning paths, lecții AI, quiz-uri și certificate PDF automate.",
    ],
    [
      "Enterprise Docs",
      "Deliverabile premium",
      "Generare de rapoarte, SOP-uri și propuneri în stil consultanță Tier-1.",
    ],
    [
      "Governance",
      "Audit & control",
      "Roluri, audit log, knowledge gaps, versionare SOP, notificări.",
    ],
  ];
  mods.forEach((m, i) => {
    const x = 0.6 + i * 3.1;
...
// ---------- SLIDE 6: ASSISTANT DEEP DIVE ----------
{
  ...
  const bullets = [
    [
      "Source-grounded",
      "Fiecare răspuns este bazat exclusiv pe documentele companiei — fără invenții.",
    ],
    [
      "Citări la vedere",
      "Panel cu sursele exacte pentru fiecare afirmație, click direct în document.",
    ],
    [
      "Confidence score",
      "Nivel de încredere pentru fiecare răspuns; scor mic → escaladare automată.",
    ],
  ...
  s.addText(
    "Conform SOP-RET-014 §3.2, retururile B2B >500€ necesită aprobare Manager Depozit și verificare fizică la Doc 7. SLA răspuns: 24h.",
    {
      x: 7.7,
      y: 3.7,
      w: 4.7,
...
// ---------- SLIDE 7: ACADEMY ----------
{
  ...
  subtitle(
    s,
    "De la Department → Learning Path → Chapter → Lesson → Quiz. Certificate PDF verificabile, generate automat.",
    1.55,
  );
...
// ---------- SLIDE 8: ENTERPRISE DOCS ----------
{
  ...
  subtitle(
    s,
    "Generează rapoarte, SOP-uri, propuneri comerciale și pachete de onboarding — cu copertă, KPI cards, tabele și export DOCX / PDF / HTML / MD.",
    1.7,
    true,
  );
  ...
  s.addText(
    "Format profesional: copertă editorială · TOC · secțiuni numerotate · KPI cards · callouts · zebra rows · fără orfane.",
    {
      x: 0.6,
      y: 6.4,
      w: W - 1.2,
...
// ---------- SLIDE 9: GOVERNANCE ----------
{
  ...
  const rows = [
    ...
    [
      "Audit log complet",
      "Cine, ce, când — pentru fiecare întrebare, upload, schimbare de rol sau publicare SOP.",
    ],
    ["Versionare SOP", "Istoric complet, comparație între versiuni, aprobări și acknowledgments."],
    [
      "Knowledge Gaps",
      "Ciclu complet: refuz AI → cerere internă → rezolvare manager → promovare în KB.",
    ],
    [
      "Notificări",
      "Email branded pentru invitații, escaladări, certificate, alerte de securitate.",
    ],
  ];
  rows.forEach((r, i) => {
    const y = 2.2 + i * 0.85;
...
// ---------- SLIDE 10: SECURITY ----------
{
  ...
  subtitle(
    s,
    "Arhitectură multi-tenant cu izolare la nivel de bază de date. Nimic nu părăsește granițele workspace-ului tău.",
    1.7,
    true,
  );
  ...
  const items = [
    ...
    [
      "EU-hosted",
      "DB pe Supabase în AWS eu-west-1 (Dublin, IE). DPA în draft. Fără antrenare pe datele tale (Google/OpenAI via Lovable AI Gateway).",
    ],
    [
      "Audit & suppression",
      "Log append-only per tenant. Suppression list pentru email compliance.",
    ],
    [
      "Subprocesori (3 niveluri)",
      "Cloudflare, Inc. (SUA) — edge/DNS/DDoS, ISO/IEC 27001, ISO/IEC 27701, SOC 2 Type II și PCI DSS Level 1 certificate; transferuri sub SCC (Art. 46 GDPR) sau EU-U.S. Data Privacy Framework, per DPA-ul Cloudflare acceptat de OPSQAI. Lovable — DB/auth/storage/AI gateway, SOC 2 Type II și ISO 27001:2022 la nivel de companie; abonament Pro tier, acoperire contractuală Business-tier în curs de confirmare, documentație la cerere; OPSQAI nu e SOC 2 / ISO 27001 certificat. Google (gemini-3-flash-preview, gemini-2.5-flash) și OpenAI (gpt-5-mini, gpt-4o-mini-tts, text-embedding-3-small) — indirect, via Lovable AI Gateway; OPSQAI nu contractează direct cu Google sau OpenAI; conținutul clienților nu e folosit pentru antrenare modele fundamentale.",
    ],
    [
      "Responsible AI",
      "Refuz explicit când nu există sursă. Transferuri extra-UE: SCC (Art. 46 GDPR).",
    ],
  ];
  items.forEach((it, i) => {
    const col = i % 3,
...
// ---------- SLIDE 14: PRICING ----------
{
  ...
  const plans = [
    {
      name: "Pilot",
      price: "30 zile",
      desc: "Pentru validare rapidă",
      features: ["Până la 25 utilizatori", "1 workspace", "Assistant + Academy", "Suport email"],
      accent: BLUE_L,
    },
    {
      name: "Standard",
      price: "Team",
      desc: "Pentru echipe operaționale",
      features: [
    ...
    },
    {
      name: "Business",
      price: "Multi-site",
      desc: "Pentru operațiuni multiple",
      features: ["Până la 500 utilizatori", "Multi-workspace", "Audit avansat", "SLA 99.9%"],
      accent: TEAL,
    },
    {
      name: "Enterprise",
      price: "Custom",
      desc: "Pentru grupuri & rețele",
      features: [
  ...
  s.addText(
    "Prețurile finale se stabilesc în funcție de scope, număr de utilizatori și cerințele de conformitate.",
    {
      x: 0.6,
      y: HGT - 0.65,
      w: W - 1.2,
...
// ---------- SLIDE 15: PILOT PLAN ----------
{
  ...
  subtitle(
    s,
    "Facem împreună un pilot ghidat: ingestie SOP-uri, activare Academy pentru un departament, măsurare impact.",
    1.7,
    true,
  );
  ...
  const phases = [
    [
      "Săptămâna 1",
      "Kick-off & ingestie",
      "Provizionare workspace · import SOP-uri · configurare roluri.",
    ],
    [
      "Săptămâna 2",
      "Activare Assistant",
      "Testare cu utilizatori-cheie · fine-tuning al surselor & FAQ.",
    ],
