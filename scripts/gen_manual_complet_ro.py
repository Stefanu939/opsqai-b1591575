...
def cover_page(canv, doc):
    ...
    canv.rect(0, PAGE_H * 0.62, PAGE_W, PAGE_H * 0.38, stroke=0, fill=1)
...
def body_page(canv, doc):
    ...
    canv.drawString(MARGIN, 12 * mm, "OPSQAI \u2014 Manualul complet (RO)")
    canv.drawRightString(PAGE_W - MARGIN, 12 * mm, f"pagina {doc.page}")
