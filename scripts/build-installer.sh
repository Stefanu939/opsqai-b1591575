...
echo "[build-installer] Regenerating src/lib/installer-binaries.generated.ts"
EXE_B64=$(base64 -w0 "$OUT/install.exe" 2>/dev/null || base64 "$OUT/install.exe" | tr -d '\n')
MAC_B64=$(base64 -w0 "$OUT/install-macos" 2>/dev/null || base64 "$OUT/install-macos" | tr -d '\n')
LIN_B64=$(base64 -w0 "$OUT/install-linux" 2>/dev/null || base64 "$OUT/install-linux" | tr -d '\n')

cat > src/lib/installer-binaries.generated.ts <<TSEOF
// Auto-generated by scripts/build-installer.sh. DO NOT EDIT BY HAND.
// Regenerate: bash scripts/build-installer.sh

export const INSTALL_EXE_B64 = "$EXE_B64";
export const INSTALL_MACOS_B64 = "$MAC_B64";
export const INSTALL_LINUX_B64 = "$LIN_B64";
TSEOF

echo "[build-installer] Wrote base64 bindings."
